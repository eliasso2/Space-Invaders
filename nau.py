...
class Nau:
    ...
    def pinta(self, w):
        w.create_rectangle(self.x, self.y, self.x + self.ample, self.y + self.alt, fill = 'navy')
        w.create_line(self.x + self.ample * (1/2), self.y, self.x + self.ample * (1/2), self.y - 10)
